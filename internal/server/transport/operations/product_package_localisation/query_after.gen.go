...
func afterQuery(productPackageID string, entities []product_package_localisation.ProductPackageLocalisation) []product_package_localisation.ProductPackageLocalisation {
	return entities
}