...
func getControllers() price_configuration_controllers.IControllers {
	return price_configuration_controllers.NewControllers()
}
...
func InitRoutes(r *gin.RouterGroup) {
	...
	// Create a new route group for the PriceConfiguration entity
	...
	group.DELETE(":priceConfigurationID", func(c *gin.Context) {
		controllers.Delete(c)
	})
	group.GET("", func(c *gin.Context) {
		controllers.GetAllPaginated(c)
	})
	group.GET(":priceConfigurationID", func(c *gin.Context) {
		controllers.Get(c)
	})
	group.POST("/query", func(c *gin.Context) {
		controllers.Query(c)
	})
	group.PUT(":priceConfigurationID", func(c *gin.Context) {
