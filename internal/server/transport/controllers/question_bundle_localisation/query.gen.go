...
func Query(c *gin.Context) {
	...
	// Get question_bundle_localisations from queries
	entities := question_bundle_localisation_operations.Query(getRepository(), questionBundleID, queryBody.Queries, queryBody.Pagination)
