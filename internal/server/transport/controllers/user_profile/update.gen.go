...
func Update(c *gin.Context) {
	...
	// Get UserProfile mapping from request body
	...
	entity := user_profile.Decode(mapping)

	// Add UserProfile to event
	user_profile_operations.Save(getRepository(), entity, utils.GetEditorId(c))
