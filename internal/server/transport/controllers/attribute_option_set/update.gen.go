...
func Update(c *gin.Context) {
	...
	// Get AttributeOptionSet mapping from request body
	...
	// Decode JSON to AttributeOptionSet
	entity := attribute_option_set.Decode(mapping)

	// Add AttributeOptionSet to event
	attribute_option_set_operations.Save(getRepository(), entity, utils.GetEditorId(c))
