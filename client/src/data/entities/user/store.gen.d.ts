...
export interface UserStore extends UserStoreState, Store {
  ...
  /**
   * Fire a store update event for all User.
   */
   ...
   * @returns {Promise<void>} A promise that resolves when the user is set as active.
   */
   ...
   * @param force Indicates whether a refresh is forced.
   * @returns {Promise<void>} A promise that resolves with an array of users.
   */
   ...
   * @param connect Indicates whether the user should be connected to the user on update.
   * @returns {Promise<string>} A promise that resolves to the ID as a string when the user is updated.
   */
  ...
  /**
    ...
    * @returns {Promise<void>} A promise that resolves with an array of users.
    */
  search: (query: string, pagination: Pagination, force?: boolean) => Promise<User[]>
}
