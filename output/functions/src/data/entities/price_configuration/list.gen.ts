...
implements IPriceConfigurationList 
{
  ...
  override async query(queries: Query[], pagination?: Pagination): Promise<PriceConfiguration[]> {
    return (await super.query(queries, pagination)) as PriceConfiguration[];
  }

  override async search(query: string, pagination?: Pagination): Promise<PriceConfiguration[]> {
    return (await super.search(query, pagination)) as PriceConfiguration[];
  }
}
