...
implements IAttributeOptionList 
{
  ...
  _kind = 'AttributeOption'
  _name = 'attribute_option'
  ...
  override async query(queries: Query[], pagination?: Pagination): Promise<AttributeOption[]> {
    return (await super.query(queries, pagination)) as AttributeOption[];
  }

  override async search(query: string, pagination?: Pagination): Promise<AttributeOption[]> {
    return (await super.search(query, pagination)) as AttributeOption[];
  }
}
