...
implements IEmailList 
{
  ...
  override async query(queries: Query[], pagination?: Pagination): Promise<Email[]> {
    return (await super.query(queries, pagination)) as Email[];
  }

  override async search(query: string, pagination?: Pagination): Promise<Email[]> {
    return (await super.search(query, pagination)) as Email[];
  }
}
